...
import {
  UssGravelyWafLogItem,
  mockUssGravelyWafLogData,
  ussGravelyWafLogColumns,
} from './uss-gravely-waf-log.model';

@Component({
  selector: 'app-uss-gravely-waf-log',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './uss-gravely-waf-log.component.html',
  styleUrl: './uss-gravely-waf-log.component.scss',
})
export class UssGravelyWafLogComponent {
  // Data signals
  protected readonly data = signal<UssGravelyWafLogItem[]>(
    mockUssGravelyWafLogData
  );
  protected readonly columns = signal(ussGravelyWafLogColumns);
